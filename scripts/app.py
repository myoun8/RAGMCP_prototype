...
>>>>>>> 8130599aa85b3614a38c9635f5a49fb5cd8c9bfc
]
...
async def lifespan(app: FastAPI):
    ...
    app.state.system_instruction = (
        ...
        "files across nodes. Always plot the reduced data using plot_reduction. "
        "If reduce_files is not available, use plot_reduction.\n"
        "\n"
