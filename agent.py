...
#     temperature=0.0
# )
rchat_key = "sk-4f2c605dfda14a67a39c09077dce23a3"
    ...
    mcp_client = MultiServerMCPClient({
        "ncnr-api-server": {
            ...
            "args": [
                ...
                "--openapi-spec", r"C:\Users\ayj\OneDrive - NIST\Documents\NIST_SHIP_AYJ\openapi.json"
            ]
        },
        "partner-rag-server": {
            "transport": "stdio",
            "command": r"C:\Users\ayj\NIST_SHIP_ARIN\rawdataRAG\.venv\Scripts\python.exe",
            "args": [
                r"C:\Users\ayj\NIST_SHIP_ARIN\rawdataRAG\scripts\mcpServer.py"
            ]
        }
    })
